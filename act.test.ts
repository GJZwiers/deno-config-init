...
Rhum.testPlan("act.test.ts", () => {
    ...
    Rhum.testSuite("act()", () => {
        ...
        Rhum.testCase("should create the necessary project files in a directory with the chosen name", async () => {          
            ...
            try {
                Deno.chdir("../../");
                await Deno.remove("./integration_test_directory", { recursive: true });
            } catch(error) {
                console.log(error);   
            }
        });

        Rhum.testCase("should create the necesary project files without specifying a name", async () => {
        ...
        Rhum.testCase("should create the necesary project files when a template is specified", async () => {
            settings.entrypoint = "mod-test.ts";
            settings.depsEntrypoint = "deps-test.ts";
            settings.gitignore = ".gitignore-test";
