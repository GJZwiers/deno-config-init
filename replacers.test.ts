...
Rhum.testPlan("replacers.ts", () => {
  Rhum.testSuite("replacers", () => {
    ...
    Rhum.testCase(
      "should replace {{type:type}} syntax with the TypeScript type",
      () => {
    ...
    Rhum.testCase(
      "should remove {{type:type}} syntax if settings.extension = js",
      () => {
    ...
    Rhum.testCase(
      "should keep ``ts ... ``ts syntax if settings.extension = ts",
      () => {
    ...
    Rhum.testCase(
      "should remove ``ts ... ``ts syntax if settings.extension = js",
      () => {
        settings.extension = "js";
    ...
    Rhum.testCase(
      "should not replace TS modifiers if settings.extension = ts",
      () => {
    ...
    Rhum.testCase(
      "should remove TS modifiers if settings.extension = js",
      () => {
        settings.extension = "js";
